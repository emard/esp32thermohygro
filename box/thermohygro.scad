// box for factory made PCB designed in KiCAD
...
// Front text
color(Couleur1){     
     translate([Length-(Thick*1.4),Width/2+Thick*0,(Height/2-(-Thick-m/2+(TxtSize/2)))]){// x,y,z
          rotate([90,0,90]){
              linear_extrude(height = TxtHeight,center=false){
